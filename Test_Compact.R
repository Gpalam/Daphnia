############################################################################################################
### prototype to check all the results
### Daphnia paper       GMP 15-10-2019
############################################################################################################

## set folder if not working on server
## setwd("Q:/Abteilungsprojekte/siam/Gian Marco/PUBBLICATION_RESULTS_4.1/PLOTTING")
